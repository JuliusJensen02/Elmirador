...
<head>
	...
	<style>
		...
		#paymentSumTable .subtotal td{
			border-top: 1px #1A242F solid;
			border-left: 1px #1A242F solid;
			border-right: 1px #1A242F solid;
		}
		#paymentSumTable .resfeeTotal td{
			font-weight: 600;
			border: 1px #1A242F solid;
			border-bottom: 0px;
		}
		#paymentSumTable .remfeeTotal td{
			font-weight: 600;
			border: 1px #1A242F solid;
			border-top: 0px;
		}
		#paymentSumTable .tax td{
			border-bottom: 1px #1A242F solid;
			border-left: 1px #1A242F solid;
			border-right: 1px #1A242F solid;
		}
...
<body>
	<div id="top">
		...
		<h1>Renting agreement</h1>
	</div>
	<div id="infoBox">
		<div>
			<p>CL Magnolio, 5 APT.5341 RES. Vistamar</p>
			<p>Agreement no: [reservationID]</p>
		</div>
		<div>
	...
	<table id="paymentSumTable">
		<tbody>
			...
			<tr class="resfeeTotal">
				<th>Reservation fee (25%)</th>
				<td>€ [totalPriceReservationFee]</td>
			</tr>
			<tr class="remfeeTotal">
				<th>Remaining amount (75%)</th>
				<td>€ [totalPriceRemaining]</td>
			</tr>
		</tbody>
	</table>
	<div id="footer">
